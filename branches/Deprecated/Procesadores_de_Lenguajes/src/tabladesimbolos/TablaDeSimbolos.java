...
import tabladesimbolos.declaraciones.*;
...
public class TablaDeSimbolos implements iTablaDeSimbolos{
	...
	private boolean isFuncRecur;
	private String idRecur;
	private Tipo retornoRecur;
	private ArrayList<Tipo> paramRecur;
	...
	public boolean declaredID(String s) throws TableException{
		return this.declaredID(this.getConexto(), s);
	}
	...
	public boolean declaredFunc(String s){
		if(this.tablaFuncProc.existeID(s)){
			...
			if(this.isFuncRecur && this.idRecur.equalsIgnoreCase(s)){
				return true;
			}else{
				return false;
			}
	...
	public boolean addParam(String id, Tipo tipo, boolean byref) throws TableException, SemanticException{
		return this.addParam(id, tipo, byref, this.getConexto());
	}
	...
	public boolean addConst(String id, Tipo tipo, String valor)throws SemanticException{
		return this.addConst(id, tipo, valor, this.getConexto());
	}
	...
	public boolean addFunc(String id, ArrayList<Tipo> param, Tipo retorno)throws SemanticException{
		return this.addFunc(id, param, retorno, this.getConexto());
	}
	...
	public boolean addProc(String id, ArrayList<Tipo> param)throws SemanticException{
		return this.addProc(id, param, this.getConexto());
	}
	...
	public boolean checkParam(String id,ArrayList<Tipo> params) throws TypeException {
		...
		if(func==null){
			if(this.isFuncRecur && this.idRecur.equalsIgnoreCase(id)){
				if(this.paramRecur != null && params != null){
					if(this.paramRecur.size() == params.size()){
						Iterator<Tipo> it1 = this.paramRecur.iterator();
					...
					if(((this.paramRecur==null)&& (params == null || params.size()==0)) || ((params==null)&& (this.paramRecur == null || this.paramRecur.size()==0))){
						return true;
					}else{
	...
	public Tipo getTipo(String id) throws TableException{
		return this.getTipo(this.getConexto(), id);
	}
	...
	public Declaraciones get(String id) throws TableException{
		return this.get(this.getConexto(), id);
	}
	...
	public void setRetornoRecur(Tipo retornoRecur) {
		this.retornoRecur = retornoRecur;
	}
	...
	public void setFuncRecur(boolean isFuncRecur) {
		this.isFuncRecur = isFuncRecur;
	}
	
	public void resetRecur(){
		this.isFuncRecur = false;
	}
}
