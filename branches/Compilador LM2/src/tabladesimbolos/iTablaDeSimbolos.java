...
public interface iTablaDeSimbolos {
	...
	/** Retorna si es un ID que no puede ser utilizado para evitar conflictos con Assembler
	 * @param s
	 * @return true si no puede ser usado, false si puede ser utilizado*/
	public boolean prohibitedID(String s);
	boolean checkParamDesconocidas(String id, ArrayList<Tipo> params)
